...
<div class="col-md-6 mb-4">
    <div class="card border-0 h-100">
        ...
        <div class="card-body">
            <?php if (!empty($request_data['cancelled_estimates']) && count($request_data['cancelled_estimates']) > 0): ?>
                <div class="table-responsive">
                    <table class="table table-sm">
                        ...
                        <tbody>
                            <?php foreach ($request_data['cancelled_estimates'] as $estimate): ?>
                            <tr>
                                <td>
                                ...
                                <td><?= date('M j, Y', strtotime($estimate['cancelled_date'])) ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
